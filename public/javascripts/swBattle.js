...
var generateMap = function (data, socket) {
  ...
  $('#gaming').append('<span id="a-nick" class="bat-nick" style="position: absolute; bottom: 20px; left: 0px"></span>' + '<span id="d-nick" class="bat-nick" style="' +
